...
##              datapath entity. It adds some useful signals for testing
...
add wave -noupdate -label CLK /tb_datapath/CLK
add wave -noupdate -label reset /tb_datapath/reset
...
add wave -noupdate -radix unsigned /tb_datapath/s_iImm
add wave -noupdate -radix unsigned /tb_datapath/s_iRS1
add wave -noupdate -radix unsigned /tb_datapath/s_iRS2
add wave -noupdate -radix unsigned /tb_datapath/s_iRD
add wave -noupdate -radix unsigned /tb_datapath/s_inZero_Sign
add wave -noupdate -radix unsigned /tb_datapath/s_inAdd_Sub
add wave -noupdate -radix unsigned /tb_datapath/s_iALUSrc
add wave -noupdate -radix unsigned /tb_datapath/s_iregWrite

# INPUT/OUTPUT added here
add wave -noupdate -divider {Data Input/Outputs}
add wave -noupdate -radix unsigned /tb_datapath/s_ioD
...
add wave -noupdate -radix unsigned /tb_datapath/s_oCo
...
#add wave -noupdate /tb_datapath/DUT0/g_Weight/iLd
#add wave -noupdate /tb_datapath/DUT0/g_Weight/sQ
#add wave -noupdate /tb_datapath/DUT0/g_Weight/oQ

# The following command will add all of the signals within the DUT0 module's scope (but not internal
# signals to submodules).
#add wave -noupdate /tb_datapath/DUT0/*

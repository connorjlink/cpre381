...
quit -sim
vcom -2008 -work work hmu.vhd
vcom -2008 -work work tb_hmu.vhd
vsim -voptargs=+acc tb_hmu
...
add wave -noupdate -label CLK /tb_hmu/CLK
add wave -noupdate -label reset /tb_hmu/reset
...
add wave -noupdate -radix hexadecimal /tb_hmu/*
